        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StateId = table.Column<int>(type: "int", nullable: false, comment: "Id tabla")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Nombre del estado"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateId = table.Column<int>(type: "int", unicode: false, nullable: false, comment: "Id tabla foranea"),
            ...
            migrationBuilder.InsertData(
                schema: "Parametrization",
                table: "State",
                columns: new[] { "StateId", "CreateAt", "Description", "Name", "UpdateAt" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Estado Activo", "Activo", null },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Estado Inactivo", "Inactivo", null },
                    { 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Estado Expirado", "Expirado", null },
                    { 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Estado Restaurado", "Restaurado", null }
                });
